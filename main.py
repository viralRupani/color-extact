...
def show_image():
    with Image.open(f'static/image/image.{FILE_FORMATE}') as image:
    ...
    return render_template('image.html', formate=FILE_FORMATE, imagedata=imagedata, color_dictionary=color_dictionary)
